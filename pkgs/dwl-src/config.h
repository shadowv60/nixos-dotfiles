...
static const float fullscreen_bg[] = {0.117f, 0.133f, 0.141f,
                                      1.0f}; // Matches col_bg

static uint32_t colors[][3] = {
    /* fg          bg          border    */
    [SchemeNorm] = {0xbbb49dff, 0x1e2224ff,
                    0x49504fff}, // Vintage Bone, Abyss, Steel Shadow
    [SchemeSel] = {0xece6d9ff, 0x1e2224ff,
                   0xbbb49dff}, // Bleached Bone, Abyss, Vintage Bone
...
static const char *const autostart[] = {
    "swaybg", "-i",   "/home/wolk/nixos-dotfiles/walls/d1P6xtd.jpeg",
    "-m",     "fill", NULL,
    NULL /* terminate */
};
...
static const char *suwa_start[] = {
    "/home/shadow/docker/suwayomi/start-suwayomi-latest.sh", NULL};
static const char *suwa_stop[] = {
    "/home/shadow/docker/suwayomi/stop-suwayomi.sh", NULL};
static const char *rofifinder[] = {
    "/home/shadow/.local/bin/scripts/rofifinder.sh", NULL};
static const char *powermenucmd[] = {"/home/shadow/.local/bin/scripts/power.sh",
                                     NULL};
...
static const Key keys[] = {
    ...
    {MODKEY, XKB_KEY_s, spawn,
     SHCMD("grim ~/Pictures/$(date +%Y-%m-%d-%H%M%S)_screenshot.png")},
